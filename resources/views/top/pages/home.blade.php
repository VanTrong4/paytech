...
@section('description', '「売掛金の回収が間に合わない！」など資金調達のお悩みは尽1きないものです。そのお悩み『PayTech(ペイテック)』にお任せください。業界“最速”の審査時間と業界“最安”の手数料を実現！資金調達でお悩みのお客様を手助けいたします。')
...
<main>
    ...
    <div class="section__tech">
        <div class="container">
            ...
            <p class="two-men">
                <img src="{{ asset('templates/frontend/images/two-men.png') }}" alt="握手をするサラリーマン">
            </p>
            ...
            <div class="list-btn-low">
                <div class="sub">
                    <p class="img"><img src="{{ asset('templates/frontend/images/icon-ls-01.png') }}" alt="お申し込みフォームはこちら"></p>
                    <p class="title">日本全国24時間受付中</p>
                    <p class="btn-ls"><a href="{{ route(lp().'contact') }}" class="btn">お申し込みフォームはこちら</a></p>
                </div>
                <div class="sub">
                    <p class="img"><img src="{{ asset('templates/frontend/images/icon-ls-02.png') }}" alt="計算シミュレーターはこちら"></p>
        ...
        <div class="container">
            ...
            <div class="list-two-kame">
                <div class="sub">
                    ...
                    <p class="img">
                        <img src="{{ asset('templates/frontend/images/img-price-01.png') }}" alt="2社間ファクタリング">
                    </p>
                </div>
                <div class="sub">
                    <p class="title">3社間ファクタリング</p>
                    <p class="img">
                        <img src="{{ asset('templates/frontend/images/img-price-02.png') }}" alt="3社間ファクタリング">
                    </p>
    ...
    <div class="section__yau">
        <div class="container">
            ...
            <div class="list-btn-low">
                <div class="sub">
                    <p class="img"><img src="{{ asset('templates/frontend/images/icon-ls-01.png') }}" alt="日本全国24時間受付中"></p>
                    <p class="title">日本全国24時間受付中</p>
                    <p class="btn-ls"><a href="{{ route(lp().'contact') }}" class="btn">お申し込みフォームはこちら</a></p>
                </div>
                <div class="sub">
                    <p class="img"><img src="{{ asset('templates/frontend/images/icon-ls-02.png') }}" alt="買取金額と概算手数料を知りたい方"></p>
                    <p class="title">買取金額と概算手数料を知りたい方</p>
                    <p class="btn-ls"><a href="{{ route(lp().'home') }}#quick" class="btn">計算シミュレーターはこちら</a></p>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="list-step">
                <div class="sub">
                    ...
                    <div class="des">
                        <p class="img"> <img src="{{ asset('templates/frontend/images/step-03.png') }}" alt="送金する男性"></p>
                        <p class="text">
                ...
                <div class="sub">
                    ...
                    <div class="des">
                        <p class="img"> <img src="{{ asset('templates/frontend/images/step-02.png') }}" alt="通帳を見て驚いてる男性"></p>
                ...
                <div class="sub">
                    ...
                    <div class="des">
                        <p class="img"> <img src="{{ asset('templates/frontend/images/step-01.png') }}" alt="PCからアップロードしている男性"></p>
                        <p class="text">
    ...
    <div class="section__cloud">
        <div class="container">
            ...
            <div class="img">
                <img src="{{ asset('templates/frontend/images/cloudsign_logo.png') }}" alt="PayTech -ペイテック-ではクラウドサインを導入しております">
            </div>
        ...
        <div class="container">
            ...
            <div class="list-carodi">
                <div class="sub">
                    ...
                    <p class="img"> <img src="{{ asset('templates/frontend/images/carodi-01.png') }}" alt="スマホを操作する人"></p>
                </div>
                <div class="sub">
                    <p class="title">02.現金化</p>
                    <p class="des">お申し込み内容確認、審査を行い、審査結果をご連絡後問題が無ければ、最短90分でお客様の口座へお振込みします</p>
                    <p class="img"> <img src="{{ asset('templates/frontend/images/carodi-02.png') }}" alt="通帳を見て喜んでいる男性"></p>
                </div>
                <div class="sub">
                    <p class="title">03.弊社へお振込み</p>
                    <p class="des">ご利用後、取引先から売掛金を回収頂けましたら、支払い期日までに、弊社指定の口座へお振込ください。</p>
                    <p class="img"> <img src="{{ asset('templates/frontend/images/carodi-03.png') }}" alt="送金する男性と受け取る女性"></p>
                </div>
            </div>
        ...
        <div class="container">
            <div class="member-after">
                ...
                <div class="list-member">
                    <div class="sub">
                        <div class="info">
                            <div class="avt"><img src="{{ asset('templates/frontend/images/avt-02.png') }}" alt="大阪府 30代のケース"></div>
                    ...
                    <div class="sub">
                        <div class="info">
                            <div class="avt"><img src="{{ asset('templates/frontend/images/avt-01.png') }}" alt="東京都 40代のケース"></div>
...
<link
    ...
    rel="stylesheet">
<link rel="stylesheet" href="{{ asset('templates/frontend/css/top.css') }}">
...
<script>
const pref_city_url = "{{ asset('templates/frontend/js/pref_city.json') }}";
</script>
<script src="{{ asset('templates/frontend/js/step.js?v4') }}"></script>
@endsection