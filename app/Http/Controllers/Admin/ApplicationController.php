...
class ApplicationController extends Controller
{
  ...
  public function index(Request $request)
  {
    ...
    $applications = Application::with(['user'])->orderBy('created_at', 'DESC')
      ->where(function ($query) use ($keyword) {
        if ($keyword) {
          return $query->where('line_id', 'LIKE', '%' . $keyword . '%')
            ->orWhere('preferred_contact', 'LIKE', '%' . $keyword . '%')
            ->orWhere('prefect', 'LIKE', '%' . $keyword . '%')
            ->orWhere('district', 'LIKE', '%' . $keyword . '%')
            ->orWhere('address', 'LIKE', '%' . $keyword . '%')
            ->orWhere('apartment_room', 'LIKE', '%' . $keyword . '%')
            ->orWhere('company_prefect', 'LIKE', '%' . $keyword . '%')
            ->orWhere('company_district', 'LIKE', '%' . $keyword . '%')
            ->orWhere('company_address', 'LIKE', '%' . $keyword . '%')
            ->orWhere('company_apartment_room', 'LIKE', '%' . $keyword . '%')
            ->orWhere('company_phonenumber', 'LIKE', '%' . $keyword . '%')
            ->orWhere('bank_name', 'LIKE', '%' . $keyword . '%')
            ->orWhere('branch_name', 'LIKE', '%' . $keyword . '%')
            ->orWhere('branch_number', 'LIKE', '%' . $keyword . '%')
            ->orWhere('account_type', 'LIKE', '%' . $keyword . '%')
            ->orWhere('account_number', 'LIKE', '%' . $keyword . '%')
            ->orWhere('account_name_kana', 'LIKE', '%' . $keyword . '%')
            ->orWhere('prefect', 'LIKE', '%' . $keyword . '%')
            ->orWhere('district', 'LIKE', '%' . $keyword . '%');
        }
        return $query;
